<div class="control_frm" style="margin-top:25px;">
    <div class="bc">
        <ul id="breadcrumbs" class="breadcrumbs">
        	            <li><a href="index.php?com=post&act=man<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>"><span>bài viết</span></a></li>
...
<form name="supplier" id="validate" class="form" action="index.php?com=baiviet&act=save_danhmuc<?php if($_REQUEST['curPage']!='') echo'&curPage='.$_REQUEST['curPage'];?><?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" method="post" enctype="multipart/form-data">
     ...
     <div class="widget">
       ...
       <div id="info" class="tab_content">
        ...
        <div class="formRow">
            <div class="formRight">
                ...
                <a href="index.php?com=baiviet&act=man_danhmuc<?php if($_REQUEST['curPage']!='') echo'&curPage='.$_REQUEST['curPage'];?><?php if($_REQUEST['type']!='') echo'&type='.$_REQUEST['type'];?>" onClick="if(!confirm('Bạn có muốn thoát không ? ')) return false;" title="" class="button tipS" original-title="Thoát">Thoát</a>
            </div>
            <div class="clear"></div>
        </div>
       ...
       <div id="content_lang_<?=$key?>" class="tab_content">        
            ...
            <div class="formRight">
                <input type="text" name="ten_<?=$key?>" title="Nhập tên bài viết" id="ten_<?=$key?>" class="tipS" value="<?=@$item_lang['ten']?>" />
            </div>
            <div class="clear"></div>
        </div>  
        ...
        <div class="formRow">
            ...
            <div class="formRight">
                <textarea rows="8" cols="" title="Viết mô tả ngắn bài viết" class="tipS" name="mota_<?=$key?>" id="mota_<?=$key?>"><?=@$item_lang['mota']?></textarea>
            </div>
            <div class="clear"></div>
        </div>  
         <div class="formRow">
