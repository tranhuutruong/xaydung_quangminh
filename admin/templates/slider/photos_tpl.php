    ...
    <?php for($i=0, $count=count($items); $i<$count; $i++){?>
       ...
       <td>
        ...
        <td class="actBtns">
            ...
            <a href="" onclick="CheckDelete('index.php?com=slider&act=delete_photo&id=<?=$items[$i]['id']?><?php if($_REQUEST['id_slider']!='') echo'&id_slider='. $_REQUEST['id_slider'];?><?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?><?php if($_REQUEST['p']!='') echo'&p='.$_REQUEST['p'];?>'); return false;" title="" class="smallButton tipS" original-title="Xóa hình ảnh"><img src="./images/icons/dark/close.png" alt=""></a>        </td>
      </tr>
         <?php } ?>
    </form>
    </tbody>
