    ...
    <tbody>
       ...
       <td>
        ...
        <td class="actBtns">
            ...
            <a href="index.php?com=order&act=edit&id=<?=$items[$i]['id']?>&thanhpho_item=<?=$items[$i]['thanhpho']?>&thanhpho=<?=$items[$i]['quan']?>&phuong=<?=$items[$i]['phuong']?>" title="" class="smallButton tipS" original-title="Xem và sửa đơn hàng"><img src="./images/icons/dark/preview.png" alt=""></a>
