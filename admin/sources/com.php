...
function get_items(){
	...
	$sql = "select * from #_com where id<>0 ";
	if($_REQUEST['key']!='')
	{
	...
	$url = "index.php?com=com&act=man&curPage=".$_REQUEST['curPage'];
	$maxR = 20;
	$maxP = 4;
...
function delete_item(){
	global $d;
		...
		if($d->query($sql))
			...
			transfer("Xóa dữ liệu bị lỗi", "index.php?com=com&act=man&curPage=".$_REQUEST['curPage']."");
	}
		elseif (isset($_GET['listid'])==true)
	{
		...
		redirect("index.php?com=com&act=man&curPage=".$_REQUEST['curPage']."");
		}
	else transfer("Không nhận được dữ liệu", "index.php?com=com&act=man&curPage=".$_REQUEST['curPage']."");}
?>